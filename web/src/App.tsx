...
const ABOUT_EN = {
  title: 'About Vishal',
  paragraphs: [
    "I'm Vishal — a software engineer who builds the parts of fintech nobody notices until they break: event pipelines, ledgers, and the services in between. Seven years across banking, manufacturing and trading platforms, mostly TypeScript and Java on AWS.",
  ],
}
    ...
    <>
      ...
      <motion.div className="hero-chrome" style={{ opacity: heroChromeOpacity }} aria-hidden="true">
        ...
        <div className="hero-meta hm-tl">
          <span className="hm-name">Vishal Ippili</span>
